	...
	def init = { servletContext ->
		try {
			if (Role.count() == 0) {
				...
				tres.addToDataChoices(name: '30 Yr CMT Maturity Rate', key: 'FRED/DGS30.json?')
				tres.addToDataChoices(name: '20 Yr CMT Maturity Rate', key: 'FRED/DGS20.json?')
				tres.addToDataChoices(name: '10 Yr CMT Maturity Rate', key: 'FRED/DGS10.json?')
				tres.addToDataChoices(name: '5 Yr CMT Maturity Rate', key: 'FRED/DGS5.json?')
				tres.addToDataChoices(name: '3 Yr CMT Maturity Rate', key: 'FRED/DGS3.json?')
				tres.addToDataChoices(name: '2 Yr CMT Maturity Rate', key: 'FRED/DGS2.json?')
