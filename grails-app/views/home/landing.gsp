	...
	<div id='content'>
		...
		<div class="wrapper">
			<div class="box">
				...
				<!-- 	<button style="width: 150px; height: 50px; font-size: x-large; margin-bottom: 10px; background-color: orange;">Contact Us to Register</button>
				-->
				<p><b><i>Please contact register@augurworks.com to request an account</i></b></p>
				</form>
			</div>
		</div>
