	...
	<div id='content' style='padding: 10px;'>
		...
		<div class="buttons">
			<div class="button-line">
				<div class="qtipText" title="Select a type of data to plot.">Select: <g:select name="algo" from="${ algorithms }" optionKey="name" /></div>
			</div>
			<div class="button-line">
		...
		<script type="text/javascript">
			var allObj = $.parseJSON("${allObj}".replace( /\&quot;/g, '"' ))
			console.log(allObj)
